...
from ..model import *
from .model import *
from .dataset import CommonVoiceGenderDataset, collate_fn
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, downstream_expert, expdir, **kwargs):
        ...
        if kwargs.get('mode', 'train') == "inference":
            ...
            traindataset = CommonVoiceGenderDataset(train_meta, segment_size)
            ...
            self.test_dataset = CommonVoiceGenderDataset(test_meta, segment_size)
